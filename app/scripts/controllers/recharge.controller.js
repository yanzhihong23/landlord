...
angular.module('landlordApp')
	.controller('RechargeCtrl', function($scope, $rootScope, $state, UserApi, PayApi, userConfig, md5, utils, toaster, $ionicLoading, $ionicActionSheet, $ionicModal, accountService) {
		var accountInfo,
				sessionId,
				mId,
				payMode = 1, // bank
